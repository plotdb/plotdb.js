...
var slice$ = [].slice;
(function(){
  var ChartBase, ChartClass, xxChart;
  ChartBase = {
    sample: function(){
      return this.call('sample', arguments);
    },
    init: function(){
      return this.call('init', arguments);
    },
    parse: function(){
      return this.call('parse', arguments);
    },
    bind: function(){
      return this.call('bind', arguments);
    },
    resize: function(){
      return this.call('resize', arguments);
    },
    render: function(){
      return this.call('render', arguments);
    },
    destroy: function(){
      return this.call('destroy', arguments);
    },
    on: function(n, cb){
      var ref$;
    ...
    attach: function(root){
      ...
      this.chart.root = root;
      return root.innerHTML = "attached";
    },
    localib: function(){},
    update: function(){},
    theme: function(){},
  ...
  ChartClass = function(opt){
    var f, base, code, chart;
    f = function(){
      this.chart = chart;
    ...
    base = import$({}, ChartBase);
    code = (opt.src || (opt.src = {})).js || (opt.code || (opt.code = {})).content;
    if (code[0] === '{') {
    ...
    chart = eval(code + "\n//# sourceURL=eval.js");
    base.call = function(n, args){
      if (this.chart[n]) {
        return this.chart[n].call(this.chart, args);
      }
    };
    f.prototype = import$(Object.create(Object.prototype), base);
    f.prototype.constructor = f;
    import$(f, base);
    return f;
  };
  plotdb.load = function(opt, cb){
    var promise, ret;
    promise = typeof opt === 'object'
      ? ret = ChartClass(opt)
      : new Promise(function(res, rej){
        ...
        if (!isNaN(+opt)) {
          req.open('get', plotdb.host + "/" + plotdb.endpoint + "/" + opt, true);
        } else {
          req.open('get', opt, true);
        }
        return req.send();
      });
  ...
  plotdb.chart = function(){};
  return xxChart = function(){};
})();
